namespace Serene.MovieDB {
    ...
    export namespace MovieGenresRow {
        ...
        ['MovieGenreId', 'MovieId', 'GenreId', 'MovieTitle', 'MovieDescription', 'MovieStoryline', 'MovieReleaseYear', 'MovieReleaseDate', 'MovieRuntime', 'MovieKind', 'GenreName'].forEach(x => (<any>Fields)[x] = x);
    }
}
