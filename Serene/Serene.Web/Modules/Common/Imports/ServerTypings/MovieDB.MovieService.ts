namespace Serene.MovieDB {
    export namespace MovieService {
        ...
        export declare function List(request: Modules.MovieDB.Movie.MovieListRequest, onSuccess?: (response: Serenity.ListResponse<MovieRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
